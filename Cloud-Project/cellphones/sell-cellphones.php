...
<html lang="en">
<head>
    <title>Sell Cellphones Page</title>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <header>
            <div class="logo">
                <a href="sell-cellphones.php">
                    <img src="images/logo/sell-mobile.png" class="logos" alt="Sell mobile logo">
                </a>
            </div><!--banner-->
                ...
                <main>
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td class="insidetable1"><button class="btn2 contact" onclick="sellFunction()"><b>Send</b></button></td>
